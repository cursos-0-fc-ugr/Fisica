...
![Onda Electromagnética, donde $\vec S$ es la dirección de propagación.<br><small>Modificado a partir de un original de SuperManu (vía Wikimedia Commons), bajo licencia CC BY-SA 3.0.</small>](media/Onda_Electromagnetica.png){width=50%}
:::
...
::: {style="text-align:center;"}
![Espectro Electromagnético. <br><small>Modificado a partir de un original de Ignacio Icke (vía Wikimedia Commons), basado en NASA/Inductiveload.</small>](media/Espectro_Electromagnetico.png){width=100%}
:::
...
::: {style="text-align:center;"}
![Reflexión y Refracción de una onda en una superficie](media/Reflexion_Refraccion.png){width=50%}
:::
...
:::{style="text-align:center;"}
![$n_1<n_2$](media/Refraccion_Caso1.png){width=40%}
:::
...
:::{style="text-align:center;"}
![$n_1>n_2$](media/Refraccion_Caso2.png){width=40%}
:::
...
::: {style="text-align:center;"}
![Ángulo límite](media/Reflexion_Total.png){width=100%}

:::

::: {style="text-align:center;"}
![Reflexión total interna](media/Reflexion_Total2.png){width=100%}
:::
...
:::{style="text-align:center;"}
![Esquema de una fibra óptica <small>[IA: Gemini]</small>.](media/Fibra_optica.png){width=50%}
:::
...
::: {style="text-align:center;"}
![Esquema de eclipses <small>[IA: Gemini]</small>.](media/Eclipse.png){width=50%}
:::
...
::: {style="text-align:center;"}
![Esquema de la cámara oscura <small>[IA: Gemini]</small>.](media/Camara_Oscura.png){width=50%}
:::
...
::: {style="text-align:center;"}
![Esquema de un lápiz en un vaso con agua.](media/lapiz_vaso.png){width=30%}
:::
...
::: {style="text-align:center;"}
![Imagen real](media/Objeto_Imagen1.png){width=100%}

:::

::: {style="text-align:center;"}
![Imagen virtual](media/Objeto_Imagen2.png){width=100%}
:::
...
::: {style="text-align:center;"}
![Esquema de una imagen real, menor e invertida.](media/arbol_SO.png){width=80%}
:::
...
::: {style="text-align:center;"}
![Foco objeto real](media/Foco_Objeto.png){width=100%}

:::

::: {style="text-align:center;"}
![Foco imagen real](media/Foco_Imagen.png){width=100%}
:::
...
::: {style="text-align:center;"}
![Distancias y tamaños, objeto e imagen.](media/arbol_lente.png){width=80%  fig-alt="Distancias y tamaños, objeto e imagen." .lightbox #fig-distancias}
:::
...
::: {style="text-align:center;"}
![Trazado de rayos. Rayo paralelo (azul), focal (verde) y central (rojo).](media/marcha_rayos.png){width=80% .lightbox #fig-lente-delgada}
:::
...
::: {style="text-align:center;"}
![Lentes convergentes.](media/Lentes_Convergentes.png){width=80%}
:::
...
::: {style="text-align:center;"}
![Lentes divergentes.](media/Lentes_Divergentes.png){width=80%}
:::
...
::: {style="text-align:center;"}
![Foco imagen de lente convergente](media/Lente_convergente_foco.png){width=100%}

:::

::: {style="text-align:center;"}
![Foco imagen de lente divergente](media/Lente_divergente_foco.png){width=100%}
:::
...
::: {style="text-align:center;"}
![Marcha de rayos de una lente convergente](media/Marcha_lente_a_7.png){width=80%}
...
::: {style="text-align:center;"}
![Marcha de rayos de una lente divergente](media/Marcha_lente_c_7.png){width=80%}
...
::: {style="text-align:center;"}
![Foco imagen de un espejo cóncavo](media/Foco_imagen_espejo.png){width=60%}

:::

::: {style="text-align:center;"}
![Foco objeto de un espejo cóncavo](media/Foco_objeto_espejo.png){width=60%}
:::
...
::: {style="text-align:center;"}
![Marcha de rayos en un espejo cóncavo](media/Marcha_rayos_espejo_concavo.png){width=40%}

:::

::: {style="text-align:center;"}
![Marcha de rayos en un espejo convexo](media/Marcha_rayos_espejo_convexo.png){width=90%}
:::
