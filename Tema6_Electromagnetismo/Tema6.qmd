...
![Izquierda: campo magnético alrededor de un imán. Derecha: campo magnético en torno a la Tierra](media/teoria-campo_magnetico.png){width="60%" #fig-campo_magnetico}
:::
...
::: {style="text-align:center;"}
![Ejemplos de producto vectorial](media/teoria-producto_vectorial.png){width="60%" #fig-producto_vectorial}
:::
...
::: {style="text-align:center;"}
![](media/teoria-ley_Lorentz.png){width="60%" #fig-ley_Lorentz}
:::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley_Lorentz-1.png){width="25%"}
:::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley_Lorentz-1-sol.png){width="25%"}
:::
::::
:::::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley_Lorentz-1neg.png){width="25%"}
:::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley_Lorentz-1neg-sol.png){width="25%"}
:::
::::
:::::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley_Lorentz-2.png){width="20%"}
:::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley_Lorentz-2-sol.png){width="15%"}
:::
::::
:::::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley_Lorentz-3.png){width="25%"}
:::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley_Lorentz-3-sol.png){width="25%"}
:::
::::
:::::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley_Lorentz-3neg.png){width="25%"}
:::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley_Lorentz-3neg-sol.png){width="25%"}
:::
::::
:::::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley_Lorentz-4.png){width="25%"}
:::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley_Lorentz-4-sol.png){width="25%"}
:::
::::
:::::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley_Lorentz-4neg.png){width="25%"}
:::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley_Lorentz-4neg-sol.png){width="25%"}
:::
::::
:::::
::::::
...
::: {style="text-align:center;"}
![Descomposición del vector velocidad en componente paralela y perpendicular al campo magnético](media/teoria-vparalelo.png){width="35%" #fig-vparalelo}
:::
...
::: {style="text-align:center;"}
![](media/teoria-triedro.png){width="45%" #fig-triedro}
:::
...
:::{style="text-align:center;"}
![](media/ejercicios-magnetismo2-1-sol.png){width="30%"}
:::
...
:::{style="text-align:center;"}
![Trayectoria de una carga en un campo magnético](media/teoria-ciclotron.png){width="35%" #fig-ciclotron}
:::
...
::: {style="text-align:center;"}
![Esquema de la velocidad de una carga en el seno de un campo magnético perpendicular, en dos instantes de tiempo $\vec{v}_0$ y $\vec{v}$ y de la aceleración que experimenta.](media/teoria-aceleracion.png){width="35%" #fig-aceleracion}
:::
...
::: {style="text-align:center;"}
![Distintos instantes de la trayectoria helicoidal de una carga que se mueve en una dirección no perpendicular al campo magnético](media/teoria-trayectoria_helicoidal.png){width="70%" #fig-trayectoria_helicoidal}
:::
...
:::{style="text-align:center;"}
![](media/ejercicios-fuerzaBE.png){width="50%"}
:::
...
:::{style="text-align:center;"}
![](media/ejercicios-ley_LorentzG-2sol.png){width="35%"}
:::
::::
:::::
...
::: {style="text-align:center;"}
![](media/ejercicios-ley-Lorentz-5.png){width="30%"}
:::
...
:::{style="text-align:center;"}
![](media/ejercicios-trayectoria_helicoidal.png){width="35%"}
:::
::::
:::::
::::::
...
::: {style="text-align:center;"}
![Esquema de la fuerza que actúa sobre un conductor rectilíneo](media/teoria-conductor_rectilineo.png){width="40%" }
:::
...
::: {style="text-align:center;"}
![Fuerza que actúa sobre una espira](media/teoria-espira.png){width="60%"}
:::
...
::: {style="text-align:center;"}
![Esquema de la regla de la mano derecha para conocer la dirección del campo magnético.](media/teoria-campo_creado_conductor.png){width="25%" #fig-campo_creado_conductor}
:::
...
::: {style="text-align:center;"}
![](media/teoria-fuerza_entre_corrientes.png){width="65%" #fig-fuerza_entre_corrientes}
:::
...
::: {style="text-align:center;"}
![Campo magnético en el eje de un solenoide.](media/teoria-solenoide.png){width="50%" #fig-solenoide}
:::
...
:::{style="text-align:center;"}
![Superficie sustentada por una espira.](media/teoria-vector_superficie.png){width="40%" #fig-vector_superficie}
:::
...
::: {style="text-align:center;"}
![Vector $d\vec{S}$ en una superficie curva.](media/teoria-vector_superficie2.png){width="45%" #fig-vector_superficie2}
:::
...
::: {style="text-align:center;"}
![Esquema de la proyección de $\vec{S}$ sobre la dirección del campo magnético.](media/teoria-flujo_superficie.png){width="45%" #fig-flujo_superficie}
:::
...
::: {style="text-align:center;"}
![Espira con un lado corredero.](media/teoria-espira_ladomovil.png){width="35%" #fig-espira_ladomovil}
:::
...
:::{style="text-align:center;"}
![](media/ejercicios-flujo1.png){width="20%"}
:::
...
::: {style="text-align:center;"}
![](media/ejercicios-flujo1-sol.png){width="20%"}
:::
...
:::{style="text-align:center;"}
![](media/ejercicios-espira_movil.png){width="25%"}
:::
...
:::{style="text-align:center;"}
![](media/ejercicios-espira_movil-sol.png){width="30%"}
:::
...
:::{style="text-align:center;"}
![](media/ejercicios-espira_movil2.png){width="25%"}
:::
...
:::{style="text-align:center;"}
![](media/ejercicios-espira_movil2-sol.png){width="25%"}
:::
...
:::{style="text-align:center;"}
![](media/ejercicios-bobina_girando.png){width="20%"}
:::
