...
1.  *Fuerza normal* $\vec{N}$: Cuando un objeto descansa o se empuja sobre una superficie, ésta ejerce una fuerza sobre el objeto, que es siempre perpendicular a la superficie.
    ...
    ![](media/Fuerza-Normal.png){width=60%}
    :::
...
:::{style="text-align:center;"}
![](media//superposicion.png){width="35%"}
:::
...
:::{style="text-align:center;"}
![](media/ejemplo-suma.png){width=30% #fig-ejemplo1}
:::
...
:::{style="text-align:center;"}
![](media/normal1-2-3.png){width=60%}
:::
...
:::{style="text-align:center;"}
![](media/pelota.png){width=25% #fig-e6}
:::
...
::: {style="text-align:center;"}
![](media/accionyreaccion.png){width=50%}
:::
...
::: {style="text-align:center;"}
![](media/problema_mano.png){width=50%}
:::
...
:::{style="text-align:center;"}
![](media/image15.png){width="2.4875in" height="1.35in" #fig-e7}
:::

::::{.callout-note title="Solución:" collapse="true" icon="false"}

:::{style="text-align:center;"}
![](media/image16.png){width="2.81875in" height="2.397222222222222in"}
:::
